...
sub is_compressed
{
    ...
    my $decrypt_cmd = "openssl aes-128-cbc -d -salt -k \"$CRYPTKEY\" -md md5";
...
sub list_tarfile
{
	...
	#
	my $untar_cmd = "cat $tarfile";
	my $decrypt_cmd = "nice openssl aes-128-cbc -d -salt -k \"$CRYPTKEY\"-md md5";
...
sub validate_crypt_key
{
    ...
    my $decrypt_cmd = "openssl aes-128-cbc -d -salt -k \"$cryptkey\" -md md5 > /dev/null 2> /dev/null";
